    ...
    return (
      <Html lang="en">
        <Head>
          ...
          {/* CLICKADU Ad Network website verification*/}
        <meta name="clckd" content="d0493fa5d67d0871a5924728cb60320f" /> 
  ...
  ></iframe>
        ...
        {/* <!-- End Google Tag Manager (noscript) --> */}
          ...
          <div>
            ...
            <p>
              That's it. You have the video thumbnail and can use it anywhere. However, some images may be subject to copyright, so make sure to get this aspect sorted before using the image publicly. You might need to ask for the author's permission, provide an attribution, and so on. 
            </p>
            <p>
            <strong>Enjoy!</strong>
            </p>
